...
export class InstructorQueryService {
   ...
   getByBranch(branchId: string): Observable<Instructor[]> {
      const q = query(this.instructorsCollection, where('branchId', '==', branchId), where('status', '==', 'activo'))
   ...
   getActive(): Observable<Instructor[]> {
      const q = query(this.instructorsCollection, where('status', '==', 'activo'))
   ...
   getByCI(ci: string): Observable<Instructor[]> {
      const q = query(this.instructorsCollection, where('ci', '==', ci.trim()), where('status', '==', 'activo'))
