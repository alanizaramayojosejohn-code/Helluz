...
@Component({
  ...
  providers: [InstructorAttendanceService, InstructorAttendanceQueryService, InstructorService, InstructorQueryService, BranchService, QueryService, ScheduleQueryService, ScheduleService],
