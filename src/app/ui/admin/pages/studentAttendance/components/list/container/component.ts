...
@Component({
  ...
  providers: [StudentAttendanceService, BranchService],
  ...
  template: `
    ...
    <mat-dialog-content>
      <form [formGroup]="form" class="py-4">
        <div class="mb-4">
          <p class="text-sm text-gray-600">Estudiante: <strong>{{ data.studentName }}</strong></p>
          <p class="text-sm text-gray-600">Sesión: <strong>#{{ data.sessionNumber }}</strong></p>
        </div>
